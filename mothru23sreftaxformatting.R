...
tax.in <- read.table("silva.full_v132.tax.temp",header=F,stringsAsFactors=F,sep="\t")
...
write.table(tax.write[,c("taxid","taxout")],file="23s_ref.silva.full_v132.tax",sep="\t",row.names=F,quote=F,col.names=F)
